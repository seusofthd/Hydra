...
public class DBAdapter {
	private static final String DATABASE_NAME = "hydra.db";
	...
	public DBAdapter(Context context, String table, ArrayList<String> keys, ArrayList<String> options) {
		...
		DATABASE_CREATE = "CREATE TABLE IF NOT EXISTS " + DATABASE_TABLE + " (" + "_id" + " INTEGER PRIMARY KEY AUTOINCREMENT, " + keyString + ");";

		Log.v("PowerDroid-Database", DATABASE_CREATE);
		// Create a new Helper
		dbHelper = new myDBHelper(context, DATABASE_NAME, null, DATABASE_VERSION, DATABASE_TABLE, DATABASE_CREATE);
	}
	 ...
	 * @return Returns the index of the row added.
	 */
...
//		Log.v("PowerDroid-Database", "Database Add: " + contentValues.toString());
	...
	public Cursor getAllEntries(String[] columns, String selection, String[] selectionArgs, String groupBy, String having, String sortBy, String sortOption) {
		return db.query(DATABASE_TABLE, columns, selection, selectionArgs, groupBy, having, sortBy + " " + sortOption);
	}
	...
	public Cursor getAllEntries(String[] columns, String selection, String[] selectionArgs, String groupBy, String having, String sortBy, String sortOption, String limit) {
		return db.query(DATABASE_TABLE, columns, selection, selectionArgs, groupBy, having, sortBy + " " + sortOption, limit);
	}
	...
	public int updateEntry(ArrayList<String> key, ArrayList<String> value) {
		...
		String[] whereArgs = new String[] { value.get(0) };
		ContentValues contentValues = new ContentValues();
		for (int i = 0; key.size() > i; i++) {
			contentValues.put(key.get(i), value.get(i));
		}

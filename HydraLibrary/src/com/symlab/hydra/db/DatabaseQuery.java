...
public class DatabaseQuery {
	...
	public DatabaseQuery(Context context) {
		...
		databaseKeys.add("recordQuantity");
		databaseKeyOptions.add("text");
	...
	public ArrayList<String> getData(String[] keys, String selection, String[] selectionArgs, String groupBy, String having, String sortBy, String sortOption) {
		...
		Cursor results = database.getAllEntries(keys, selection, selectionArgs, groupBy, having, sortBy, sortOption);
		while (results.moveToNext()) {
			...
			list.add(results.getString(results.getColumnIndex("recordQuantity")));
		}
	...
	public ArrayList<String> getData() {
		...
		while (results.moveToNext()) {
			list.add(results.getString(results.getColumnIndex("execDuration")));
			list.add(results.getString(results.getColumnIndex("energyConsumption")));
			list.add(results.getString(results.getColumnIndex("recordQuantity")));
		}
